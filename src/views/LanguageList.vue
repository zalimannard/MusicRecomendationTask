...
<script>
  ...
  export default {
    ...
    methods: {
      editItem(item){
        this.editedIndex = this.languages[this.languages.indexOf(item)].id
      ...
      deleteItemConfirm(){
        Api.language.delete(this.editedIndex)
        this.closeDelete()
      ...
      save () {
        if (this.editedItem.name != "")
        {
          if (this.editedIndex > -1) {
            Api.language.edit(this.editedIndex, this.editedItem)
          } else {
            Api.language.add(this.editedItem)
          }
          this.close()
          window.location.reload()
        }
