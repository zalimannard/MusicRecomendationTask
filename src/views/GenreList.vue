...
<script>
  ...
  export default {
    ...
    methods: {
      editItem(item){
        this.editedIndex = this.genres[this.genres.indexOf(item)].id
      ...
      deleteItemConfirm(){
        Api.genre.delete(this.editedIndex)
        this.closeDelete()
      ...
      save () {
        if (this.editedItem.name != "")
        {
          if (this.editedIndex > -1) {
            Api.genre.edit(this.editedIndex, this.editedItem)
          } else {
            Api.genre.add(this.editedItem)
          }
          this.close()
          window.location.reload()
        }
